    ...
    <Box className="flex flex-col items-center justify-center p-6 max-w-3xl mx-auto min-h-[calc(100vh-128px)]">
      <Paper sx={paperSx}>
        <Stack direction="column" alignItems="center" spacing={3}>
          ...
          >
            Empower your development workflow with intelligent code planning.
            Describe your desired code changes in natural language, and let our
            AI generate a structured plan of file modifications.
          </Typography>
          <Typography variant="body2" className="text-text-secondary mb-6">
            Review detailed plans including file additions, modifications,
            deletions, and refactors, then apply them directly to your local
