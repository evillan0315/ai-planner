...
function HomePage() {
  return (
    <Box className="flex flex-col items-center justify-center p-6 min-h-[calc(100vh-128px)]">
      ...
      >
        Explore powerful AI capabilities for intelligent code planning and
        modification.
      </Typography>

      <Box className="grid grid-cols-1 gap-8 w-full max-w-2xl">
        <Card sx={cardSx}>
          <CardContent className="flex flex-col items-center text-center">
            <AddRoadIcon
              sx={{ fontSize: 60, mb: 2, color: 'secondary.dark' }}
            />
            <Typography
              variant="h5"
              component="h2"
            ...
            <Typography variant="body1" className="text-text-secondary mb-4">
              Articulate desired code changes in natural language, receive a
              structured plan, and apply modifications directly to your local
              project.
            </Typography>
            <Button
