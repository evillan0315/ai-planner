...
import { getAuthToken } from '@/stores/authStore'; // Needed for direct connection in dialog
...
const TerminalDialog: React.FC<TerminalDialogProps> = ({
  ...
  useEffect(() => {
    ...
    let isMounted = true;
    const token = getAuthToken(); // Retrieve auth token for this dialog's connection
